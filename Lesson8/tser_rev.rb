...
if (Gem.win_platform? and ARGV[0])
  name = name.encode(ARGV[0].encoding).encode ("UTF-8")
end
...
for item in questions do 
	...
	while (user_input != "yes" and user_input != "no")
		puts "Введи yes или no и нажмите ввод"
		user_input = STDIN.gets.chomp.downcase  # checking for Yes, yes, YES, NO, No
		end
...
puts "\n Ваш результат теста (ответов да - #{yesanswers}):"

if (yesanswers >= 10)
	puts results[0]
elsif (yesanswers >= 5)# and yesanswers < 9)
	puts results[1]
else (yesanswers < 5)
	puts results[2]
end	
